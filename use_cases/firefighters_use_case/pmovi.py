from use_cases.firefighters_use_case.constants import DISCOUNT
import use_cases.firefighters_use_case.pareto_front as pareto_front
from use_cases.firefighters_use_case.env import HighRiseFireEnv
from use_cases.firefighters_use_case.scalarisation import *
import pickle
...
def get_full_q_function(env, v, discount_factor=DISCOUNT):
    """
...
def learn_and_do():
    env = HighRiseFireEnv()
    v, q = pareto_multi_objective_value_iteration(env, max_iterations=MAX_ITERATIONS, discount_factor=DISCOUNT, model_used=None, pareto=True, normalized=False)
...
if __name__ == "__main__":
    ...
    initial_state = 323
    normalisation_factor = 0.3 # because discount factor is 1 - 0.3 = DISCOUNT
