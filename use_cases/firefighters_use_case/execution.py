...
from use_cases.firefighters_use_case.constants import DISCOUNT, MAX_STEPS
...
def example_execution(policy, q,max_steps=MAX_STEPS, discount_factor=1.0, avg=False, show_q=False,verbose=True, store_all_together=False):
    """
...
if __name__ == "__main__":
    ...
    example_execution(policy, None, discount_factor=DISCOUNT, max_steps=30, verbose=True)
    print("-------------------")