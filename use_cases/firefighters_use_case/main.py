from use_cases.firefighters_use_case.constants import MAX_STEPS
from use_cases.firefighters_use_case.execution import example_execution, protocol_alignment_prediction
from use_cases.firefighters_use_case.pmovi import *
import matplotlib
...
normalisation_factor = 1 #- discount_factor  # because discount factor is 1 - 0.3 = DISCOUNT
...
example_execution(recovered_pi, None, discount_factor=discount_factor, max_steps=MAX_STEPS, verbose=True)
...
print("Pareto front: ", np.array([x, y]))
plt.scatter(x, y)
matplotlib.rcParams.update({'font.size': 22})
#pi = protocol_alignment_prediction(recovered_pi[0], discount_factor, MAX_STEPS, MAX_ITERATIONS, avg=False)
#print(pi)
