...
from baraacuda.envs import lunar_lander, breakable_bottles
...
variants_path = file_path.parent / f"{file_stem}variants_BB.yaml"
...
wrappers = [#(LL_Terminations, {}),
    (FlattenObservation, {})
            (TransformVectorReward, {"transformer": lambda vec: vec[transform_reward_idxs],
